        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				...
				<form role="form" action="${appPath}/admin/add" method="post" id="addForm">
				  ...
				  <button type="button" class="btn btn-success" onclick="$('#addForm').submit()"><i class="glyphicon glyphicon-plus"></i> 新增</button>
